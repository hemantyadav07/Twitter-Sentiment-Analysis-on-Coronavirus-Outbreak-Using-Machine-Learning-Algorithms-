   ...
   <div class="header">
      ...
      <div class="clients text-center">
	       		...
	       		<table border="5" cellpadding="5" cellspacing="8">
					...
					PreparedStatement ps = con.prepareStatement("select * from emotiondata where username='"+username+"'");
					...
					while(rs.next())
					{
						...
						<tr align="center">
							...
							<td><img  src="imgs/<%=rs.getString("emotion") %>.png" width="70" height="70"></td>							
					<%
						}
					%>
					</tr>
