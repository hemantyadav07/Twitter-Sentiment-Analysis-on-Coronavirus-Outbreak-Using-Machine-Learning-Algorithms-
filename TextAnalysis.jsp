...
%>
	...
	<div class="header">
      <div class="container">	 			
	        ...
	        <div class="h_menu4">
				...
				<ul class="nav">
					...
					<%-- <li><a href="Notification.jsp" class="service">Notification <% out.println("<span style='color:blue'> ("+nofiCount+")</span>"); %></a></li> --%>
          			<li class="active"><a href="TextAnalysis.jsp" class="clients">Sentiment Analysis</a></li>
       ...
       <div class="clients text-center">
	       		...
	       		<form action="NLPTextAnalysis" method="post">
	...
	<form id="formsearch" name="formsearch" method="post" action="TextAnalysis.jsp">  
      <span>
        <input name="search" id="s" maxlength="30" placeholder="Search Tweets" type="text" required/>
        </span> &nbsp;&nbsp;
        <input type="submit" value="Submit" id="submitButton" style="height:35px; width:90px;" />
        </form>
        </div>
		<br>
		<table border="5" cellpadding="5" cellspacing="8" style="margin-left:280px;"> 
			<tr>
				<th>Tweet Comment</th>
				<th>Sentiment</th>
			<tr>
		<%
			if(request.getParameter("search")!=null)
			{
				...
				System.out.print("Search Query "+search);
				
				Connection con =DbConnection.getConnection();
				PreparedStatement ps= con.prepareStatement("select * from `twitter`.`dataset` Order BY RAND() limit 5");
				//System.out.println("Server1:== "+ps);
