    ...
    <div class="about">
          <div class="container">
        	 <div class="about_top">
	            <div class="col-md-8">
	        	  <ul class="user_head">
	        	  	<i class="fa fa-user"> </i><h3 class="welcome_text">Welcome <%=session.getAttribute("fname") %></h3>
               ...
               <td> <a href="profilepic.jsp" >Profile Photo</a></td>
                <td><a href="deactivate.jsp" >Deactivate Account</a></td></tr>
              </table>
              </li>
	        	 <div class="clearfix"> </div>
	        	  </ul>
                     ...
                     <table align="center" class="rcorners3" cellpadding="10" cellspacing="10">
                      		<tr>
									...
									<td><%= rs.getString("password") %>
										<input type="hidden" name="pageType" value="PasswordChange"></input>
									</td>
								</tr>
								<tr>
									<td>New Password</td>
									<td>:</td>
									<td><input type="text" name="newPassword" class="form-control" style="width:100px;" class="textbox"></input></td>
								</tr>
								<tr>
									<td>Re-type Password</td>
									<td>:</td>
									<td><input type="text" name="renewPassword" class="form-control" class="textbox"></input></td>
								</tr>
								<tr>
									<td colspan="3" align="center"><input class="button" type="submit" name="Login" value="Change"></input></td>
								</tr>
						</table>
					</form>
