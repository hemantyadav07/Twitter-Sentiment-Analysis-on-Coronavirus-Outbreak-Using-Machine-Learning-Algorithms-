...
%>
   ...
   <div class="header">
      ...
      <div class="clients text-center">
	       		...
	       		<h2 align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       		<i class="fa fa-users">Tweet Comment Analysis...!</i></h2><br>
	       		<table border="5" cellpadding="5" cellspacing="8">
					...
					PreparedStatement ps = con.prepareStatement("select * from testingdata where username='"+username+"'");
					...
					while(rs.next())
					{
						...
						<tr align="center">
							...
							<td><%=rs.getString("tweet_comment") %></td>
							<td><%=rs.getString("sentiment_sts") %></td>
							<td><img  src="imgs/<%=rs.getString("sentiment_sts") %>.png" width="70" height="70"></td>							
					<%
						}
					%>
					</tr>
