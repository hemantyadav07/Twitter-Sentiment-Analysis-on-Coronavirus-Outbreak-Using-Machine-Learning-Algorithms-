	        	 ...
	        	 <div class="clearfix"> </div>
	        	  ...
	        	  <div class="about_grid">
                     ...
                     <div align="center">
                      ...
                      <tr><td><h2 style="margin-top: 0;color:#55518a">Deactivate Account</h2></td>
                      <td><a class="btn" href="DeactivateAcc?id=<%=rs.getString("id")%>" title="Edit">
                      <h3 style="margin-top: 0;color:#55518a">Deactivate Account</h3></a></td>
                      <%-- <td><a class="btn" href="RecoverAcc?userid=<%=rs.getString("userid")%>" title="Edit">
                      <input type="submit" value="Recover" class="button"></a --%></td>
                      </tr>
                      </table>
